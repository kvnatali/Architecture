...
public:
                       ...
                       HTTPServerResponse &response)
    {
        ...
        {
            std::cout << "1 form has login" << std::endl;
            ...
            {   
                try
                {
                    std::cout << "2 read form cache" << std::endl;
                    database::Users result = database::Users::read_from_cache_by_login(login);
            ...
            try
            {
                ...
                // и записываем в кеш
                database::Users result = database::Users::read_by_login(login);

                std::cout << result.get_last_name() << std::endl;

                if (!no_cache){
                    std::cout << "3 will save to cache" << std::endl;
